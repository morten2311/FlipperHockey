...
public class FlipperLeft extends  Flipper {
    ...
    public FlipperLeft(PlayScreen playScreen, float xPos, float yPos, float upperAngle, float lowerAngle, float motorSpeed, boolean left) {
        super(playScreen, xPos, yPos, upperAngle, lowerAngle, motorSpeed, left);
        vertices = new Vector2[4];
        vertices[0]=new Vector2(0/ FHGame.PPM,15/FHGame.PPM);
        vertices[1]=new Vector2(flipperLength/FHGame.PPM,10/FHGame.PPM);
        vertices[2]=new Vector2(flipperLength/FHGame.PPM,-10/FHGame.PPM);
        vertices[3]=new Vector2(0/FHGame.PPM,-15/FHGame.PPM);
        defineFlipper();
    }
}
